...
class EfficientMixer(nn.Module):
    ...
    def __init__(self, in_dims=256):
        ...
        self.w_g = nn.Parameter(torch.randn(in_dims, 1))
...
class EM_DeformerTransformer(nn.Module):
    def __init__(
        ...
        t_values = torch.linspace(0, 1, num_points)  # 生成 t 值
    ...
    def init_points_from_rom_proposals(self, reference_catrom):
        bz = reference_catrom.shape[0]
        initial_reference_points = reference_catrom.view(bz, self.num_proposals, 4, 2)
