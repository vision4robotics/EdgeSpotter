...
class TransformerPureDetector(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        catrom_matcher, point_matcher = build_matcher(cfg)
        ...
        enc_weight_dict = {
            "loss_catrom": loss_cfg.CATMULL_COORD_WEIGHT,
            "loss_ce": loss_cfg.CATMULL_CLASS_WEIGHT
        }
        ...
        self.criterion = SetCriterion(
            ...
            weight_dict,
            enc_losses,
            cfg.MODEL.TRANSFORMER.LOSS.CATMULL_SAMPLE_POINTS,
            dec_losses,
