...
_C.MODEL.TRANSFORMER.DEC_LAYERS = 3
...
# catmull-rom proposal loss
_C.MODEL.TRANSFORMER.LOSS.CATMULL_CLASS_WEIGHT = 1.0
_C.MODEL.TRANSFORMER.LOSS.CATMULL_COORD_WEIGHT = 1.0
_C.MODEL.TRANSFORMER.LOSS.CATMULL_SAMPLE_POINTS = 25
